              ...
              {(isGroupCreator || isUserAdmin) && (
                <Card className="p-5 space-y-4">
                  ...
                  <View className="flex-row gap-2 items-center">
                    <View className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 flex-row justify-between items-center">
                      <select
                        style={{ width: '100%', borderWidth: 0, outline: 'none', backgroundColor: 'transparent', fontSize: 14 }}
                        value={addingMemberId}
                        onChange={(e: any) => setAddingMemberId(e.target.value)}
                      >
