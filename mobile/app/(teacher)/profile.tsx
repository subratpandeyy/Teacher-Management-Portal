    ...
    <View className="flex-1 bg-canvas">
      <View className="px-4 pt-4">
        <Card className="items-center">
          <View className="mb-3 h-20 w-20 items-center justify-center rounded-full bg-accent-green-100">
            <Text className="text-3xl font-bold text-accent-green-700">
              {(profile?.display_name ?? user?.email ?? 'T').charAt(0).toUpperCase()}
            </Text>
          </View>
          ...
          <View className="mt-3 rounded-full bg-accent-blue-50 px-3 py-1">
            <Text className="text-xs font-semibold uppercase tracking-wide text-accent-blue-600">
              Teacher account
            </Text>
          </View>
        </Card>
