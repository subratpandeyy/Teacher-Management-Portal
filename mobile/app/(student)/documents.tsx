    ...
    <View className="flex-1 bg-slate-50">
      <View className="border-b border-slate-100 bg-white px-4 pb-4 pt-3">
        ...
        <Pressable
          ...
          disabled={uploading}
          className="mt-3 flex-row items-center justify-center gap-2 rounded-xl bg-blue-500 py-3.5 active:bg-blue-600 disabled:opacity-50"
          style={{
            shadowColor: '#3B82F6',
            shadowOpacity: 0.2,
            shadowRadius: 6,
        ...
        {status ? (
          <Text className="mt-2 text-center text-xs font-medium text-blue-600">{status}</Text>
        ) : null}
      </View>
